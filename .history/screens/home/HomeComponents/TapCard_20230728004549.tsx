...
const TapCard: React.FC<Props> = ({ navigation }) => {
    ...
    <>
      ...
      <View
        ...
        >
          <TouchableOpacity
            onPress={() => {
              navigation.navigate("PaymentMod");
            }}
          >
            <Image
        ...
        <Text style={styles.text}>Tap Your Card To </Text>
        <Image
      ...
      <View style={{ backgroundColor: "white" }}>
        ...
        >
          ...
          <Image source={require("./clear.png")} style={styles.clearIcon} />
        </TouchableOpacity>
