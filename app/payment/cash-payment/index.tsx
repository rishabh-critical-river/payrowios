...
function CashPayment() {
  ...
  const { state, onChangeTotal } = useProduct();
        ...
        <React.Fragment>
          <View style={styles.container}>
            ...
            >
              ...
              > */}
              You are about to make a payment to this company
              {/* </Text> */}
              <View
                style={{
                  borderWidth: 1,
              ...
              >
                ...
                >
                  ...
                  <View
                    style={{
                      backgroundColor: "rgba(75, 80, 80, 0.05)",
                      height: 26,
                      borderRadius: 8,
                    }}
                  >
                    ...
                    >
                      + {state?.purchaseBreakdown?.service?.length} items
                    </Text>
                  </View>
                </View>
              </View>
