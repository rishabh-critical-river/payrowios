...
function AboutPayrow({ navigation }: any) {
  ...
  return (
    <>
      ...
      >
        ...
        />
        <Image
          source={require("@/assets/logos/Heroshot.png")}
        ...
        <Image
          ...
          source={require("@/assets/logos/ceo.png")}
        />
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push(
              "/product-selection/contact/about-payrow/cash-recieved-machine"
            );
          }}
          style={{
            borderWidth: 1,
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push(
              "/product-selection/contact/about-payrow/pos-retail-machine"
            );
          }}
          style={{
            borderWidth: 1,
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push("/product-selection/contact/about-payrow/soft-pos");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push("/product-selection/contact/about-payrow/pay-by-link");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push(
              "/product-selection/contact/about-payrow/payment-gateway"
            );
          }}
          style={{
            borderWidth: 1,
        ...
        <TouchableOpacity
          onPress={() => {
            ...
            router.push("/product-selection/contact/about-payrow/wps");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            router.push("/product-selection/contact/about-payrow/vat");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            router.push("/product-selection/contact/about-payrow/e-kyc");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            router.push("/product-selection/contact/about-payrow/bnpl");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            router.push("/product-selection/contact/about-payrow/wallet");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
        ...
        <TouchableOpacity
          onPress={() => {
            router.push("/product-selection/contact/about-payrow/prepaid-card");
          }}
          style={{
            borderWidth: 1,
            borderColor: "#4B505040",
